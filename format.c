...
static
RB_HEAD (format_job_tree, format_job)
  format_jobs = RB_INITIALIZER ();
...
static char *
format_match (struct format_modifier *fm, const char *pattern,
	      const char *text)
{
  const char *s = "";
  regex_t r;
...
/* Search inside pane. */
static char *
format_search (struct format_modifier *fm, struct window_pane *wp,
	       const char *s)
{
