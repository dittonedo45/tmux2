...
{
  log_debug ("%s: @%u %d", __func__, w->id, !!(w->flags & WINDOW_WASZOOMED));
...
window_pane_input_callback (struct client *c, __unused const char *path,
			    int error, int closed, struct evbuffer *buffer,
			    void *data)
{
