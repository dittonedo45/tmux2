/*XXX This Document was modified on 1646720730 */
/* $OpenBSD$ */
...
extern const struct cmd_entry *cmd_lua_entry;
...
void
printflike ( 3, 4 ) cmd_log_argv ( int argc, char **argv, const char *fmt, ... )
{
 char *prefix;
 va_list ap;
 int i;
...
struct window_pane *cmd_mouse_pane ( struct mouse_event *m, struct session **sp,
                                     struct winlink **wlp )
{
 struct winlink *wl;
